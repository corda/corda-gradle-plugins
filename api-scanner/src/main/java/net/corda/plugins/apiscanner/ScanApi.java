...
class ScanApi extends DefaultTask {
     ...
     * It's not publicly accessible at the moment
     */
    ...
    class Scanner implements Closeable {
        ...
        void scan(File source) {
            ...
            try (
                ...
                ApiWriter writer = new JsonApiPrintWriter(target, "UTF-8")
            ) {
        ...
        void scan(ApiWriter writer, ClassLoader appLoader) {
        ...
        private void writeApis(ApiWriter writer, @Nonnull ScanResult result) {
        ...
        private void writeClass(ApiWriter writer, @Nonnull ClassInfo classInfo) {
        ...
        private void writeMethods(ApiWriter writer, List<MethodInfo> methods) {
            sort(methods);
        ...
        private void writeFields(ApiWriter writer, List<FieldInfo> fields) {
            sort(fields);

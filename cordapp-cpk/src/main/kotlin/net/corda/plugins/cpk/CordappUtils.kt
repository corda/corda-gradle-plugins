...
const val CORDA_CONTRACT_CLASSES = CORDA_PREFIX + "Contract-Classes"
const val CORDA_WORKFLOW_CLASSES = CORDA_PREFIX + "Flow-Classes"
const val CORDA_MAPPED_SCHEMA_CLASSES = CORDA_PREFIX + "MappedSchema-Classes"
const val CORDA_SERIALIZATION_WHITELIST_CLASSES = CORDA_PREFIX + "SerializationWhitelist-Classes"
const val CORDA_CHECKPOINT_CUSTOM_SERIALIZER_CLASSES = CORDA_PREFIX + "CheckpointCustomSerializer-Classes"
const val CORDA_SERIALIZATION_CUSTOM_SERIALIZER_CLASSES = CORDA_PREFIX + "SerializationCustomSerializer-Classes"
const val CORDA_NOTARY_SERVICE_CLASSES = CORDA_PREFIX + "Notary-Service-Classes"
const val CORDA_SERVICE_CLASSES = CORDA_PREFIX + "Service-Classes"

...
public class EscapeStringListTest {
    ...
    void test(List<String> strings, String expectedResult) {
        Assertions.assertEquals(expectedResult, ManifestEscape.escapeStringList(strings));
    }
}

...
class FilterTransformer private constructor (
    ...
    private val importExtra: (String) -> List<Pair<String, MethodElement>>?,
    ...
    constructor(
        visitor: ClassVisitor,
        logger: Logger,
        importExtra: (String) -> List<Pair<String, MethodElement>>?,
    ...
    override fun visitEnd() {
         ...
         * These will have been generated by an earlier pass,
         * and MUST be add just before any Kotlin metadata
         * is processed.
         */
